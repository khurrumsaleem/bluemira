...
from bluemira.base.solver import NoOpTask, SolverABC, Task
...
class _Setup(Task):
    def run(self):
        return self._make_equilibrium(), self._make_opt_problem()
...
class _Run(Task):
    def run(self, eq: Equilibrium, opt_problem: CoilsetOptimisationProblem):
